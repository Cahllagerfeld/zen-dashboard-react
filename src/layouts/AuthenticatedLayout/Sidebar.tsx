		...
		<nav className="flex w-[104px] flex-col items-center border-r border-theme-border-moderate">
			...
			<div className="h-full w-full bg-theme-surface-tertiary px-2 py-5 pt-2">
				<div className="flex h-full w-full flex-col items-center gap-1">
					<SidebarItem routePatterns={["/"]} to="/" icon={<Home />} stroke={false} label="Home" />
					<SidebarItem
						routePatterns={[routePaths.workspaces.detail(":workspace")]}
					...
					<div className="flex w-full flex-col items-center gap-2">
						<SidebarItem
							routePatterns={[
								routePaths.pipelines.overview(":workspace"),
								routePaths.pipelines.detail(":id")
							]}
					...
					<div className="flex w-full flex-col items-center gap-2">
						<SidebarItem
							routePatterns={[
								routePaths.components.overview(":workspace"),
								routePaths.components.detail(":id")
							]}
						...
						<SidebarLink
							to={routePaths.home()}
							routePatterns={[routePaths.pipelines.detail(":id"), "/profile"]}
						/>
					</div>
				</div>
			</div>
